...
// dActor_c::construct(u16 id, u32 settings, const mVec3_c* position, const mAng3_c* angle, u8 layer)
#define construct__8dActor_cFUsUlPC7mVec3_cPC7mAng3_cUc 0x80064610
...
L_LiftNearest_NotHeldAlready:;
    ...
    lbz     r0, OFFS_ACTOR_IS_PLAYER(r10);
    cmpwi   r0, 1;
    beq-    L_LiftNearest_LoopNext;
...
L_LiftNearest_LiftActor:
    ...
    bl      L_LiftNearest_BLTrick2;
    .string "Clone actor profile %d with settings %08X\n";
    .balign 4;
L_LiftNearest_BLTrick2:;
    mflr    r3;
    lhz     r4, 0x8(r9); // profName
    lwz     r5, 0x4(r9); // settings
    BL_CALL(OSReport);
    ...
    lhz     r3, 0x8(r9); // profName
    lwz     r4, 0x4(r9); // settings
    addi    r5, r31, 0xAC; // position
    addi    r6, r9, 0x100; // angle
    lbz     r7, 0x38F(r9); // layer
    BL_CALL(construct__8dActor_cFUsUlPC7mVec3_cPC7mAng3_cUc);
    ...
    // Copy player ID
    lbz     r0, OFFS_ACTOR_PLAYER_ID(r31);
    stb     r0, OFFS_ACTOR_PLAYER_ID(r3);
